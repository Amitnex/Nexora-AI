from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QStackedWidget, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QSizePolicy, QFrame
...
class ChatSection(QWidget):
    ...
    def addMessage(self, message, color):
        ...
        text_color.setForeground(QColor(color))
        cursor.setCharFormat(text_color)
